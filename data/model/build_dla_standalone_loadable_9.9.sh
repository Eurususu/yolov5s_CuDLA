...
# (yolov5_coco_qat_9.9.onnx translated by qdq_translator).
...
CALIB_CACHE=data/loadable/qat2ptq_9.9.cache
sed "1s/^TRT-[0-9]*/TRT-${TRT_VERSION}/" data/model/yolov5_coco_qat_9.9_precision_config_calib.cache > ${CALIB_CACHE}
${TRTEXEC} --minShapes=images:1x3x672x672 --maxShapes=images:1x3x672x672 --optShapes=images:1x3x672x672 --shapes=images:1x3x672x672 \
    --onnx=data/model/yolov5_coco_qat_9.9_noqdq.onnx --useDLACore=0 --buildDLAStandalone \
    --saveEngine=data/loadable/yolov5_9.9.int8.int8hwc4in.fp16chw16out.standalone.bin \
